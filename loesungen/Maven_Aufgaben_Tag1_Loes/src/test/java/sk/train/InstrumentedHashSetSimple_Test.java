...
import sk.train_inheritance.InstrumentedHashSetSimple;

class InstrumentedHashSetSimple_Test {

	private InstrumentedHashSetSimple<String> ihs;
	
	@BeforeEach
	void setUp() throws Exception {
		ihs = new InstrumentedHashSetSimple<String>();
	}
