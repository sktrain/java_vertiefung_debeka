...
public class FixGehaltMitarbeitermodell implements Gehaltsmodell{
	...
	public FixGehaltMitarbeitermodell(BigDecimal gehalt) {
		super();
		this.gehalt = gehalt;
	}
	...
	public String toString() {
		return "FixGehaltMitarbeitermodell [getGehalt()=" + getGehalt() + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FixGehaltMitarbeitermodell other = (FixGehaltMitarbeitermodell) obj;
		if (gehalt == null) {
