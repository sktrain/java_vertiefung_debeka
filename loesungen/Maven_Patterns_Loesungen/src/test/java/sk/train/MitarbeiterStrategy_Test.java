...
import sk.train.ma.strategy.ArbeiterModell;
import sk.train.ma.strategy.FixGehaltModell;
import sk.train.ma.strategy.Mitarbeiter;


class MitarbeiterStrategy_Test {
